...
* If you're using [Toolscreen](<https://github.com/jojoe77777/Toolscreen/releases/latest>): **Ctrl+I** to open the menu, then go to **Advanced** ⟶ **Inputs** ⟶ **Enable Key Rebinding** ⟶ **Open keyboard Layout** ⟶ left click on **B** ⟶ change **Triggers** to an unused key (i.e. go to **Custom** and select **F13**). If you're using B as a hotkey, you will need to set it again.
